...
fn get_user_data(user_id: &str, cache: &LRUCache<String, UserData>) -> UserData {
...
fn main() {
    ...
    // --- Single-threaded execution using LRUCache ---
    let ttl_cache = LRUCache::<String, UserData>::new(cache_capacity);
    ...
    let arc_cache = Arc::new(LRUCache::<String, UserData>::new(cache_capacity));
    let start = Instant::now();
    ...
    // Optionally, if your LRUCache has stats:
